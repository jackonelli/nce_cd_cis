...
def main(args):
    ...
    crit_dir = {
        'is': ([AemIsJointCrit], ["aem_is_j_nc"]),
        'cis': ([AemCisJointCrit], ["aem_cis_j_nc"]),
        'pers': ([AemCisJointPersCrit], ["aem_cis_pers_j_nc"]),
        'adaptive': ([AemCisJointAdaCrit], ["aem_cis_adapt_j_nc"]),
        'pers_adaptive': ([AemCisJointAdaPersCrit], ["aem_cis_pers_adapt_j_nc"]),
        'smc': ([AemSmcCrit], ["aem_smc_j_nc"]),
        'csmc': ([AemSmcCondCrit], ["aem_csmc_j_nc"]),
        'csmc_pers': ([AemSmcCondPersCrit], ["aem_csmc_pers_j_nc"]),
        'smc_adaptive': ([AemSmcAdaCrit], ["aem_smc_adapt_j_nc"]),
        'csmc_adaptive': ([AemSmcCondAdaCrit], ["aem_csmc_adapt_j_nc"]),
    }
